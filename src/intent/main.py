...
#调用这个方法
def intent(title,content):
       #在content中找高频词，并添加到title中
        with open("../data/intent_data/json.json", "r", encoding="utf-8") as f:
        ...
        vocab.load('../data/vacab.txt')
        vocab.from_dataset(dataset, field_name='chars')
        vocab.index_dataset(dataset, field_name='chars')

        dic_lable = {'0': ['控制疫情_美国'], '1': ['扰乱国际秩序'], '2': ['政治斗争'], '3': ['军事干涉世界局势'], '4': ['国际疫情政治化'], '5': ['控制暴乱'], '6': ['其他'], '7': ['缓解经济压力_美国'],
        ...
        state = torch.load('./model/best_BiLSTMMaxPoolCls_acc_2021-05-25-22-10-26-355900')
        state.eval()
        res = ''
